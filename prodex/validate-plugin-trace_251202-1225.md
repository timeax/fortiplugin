...
Included Source Files (59)
- [src/Console/Commands/ValidatePlugin.php](#1)
- [src/Contracts/ConfigInterface.php](#2)
- [src/Core/ChecksModulePermission.php](#3)
- [src/Core/Exceptions/DuplicateSettingIdException.php](#4)
- [src/Core/Exceptions/HostConfigException.php](#5)
- [src/Core/PluginPolicy.php](#6)
- [src/Core/Security/CallGraphAnalyzer.php](#7)
...
- [src/Enums/AuthorStatus.php](#19)
- [src/Enums/IssueStatus.php](#20)
- [src/Enums/PermissionType.php](#21)
- [src/Enums/PluginSettingValueType.php](#22)
- [src/Enums/PluginStatus.php](#23)
- [src/Enums/RoutePermissionStatus.php](#24)
- [src/Enums/ValidationStatus.php](#25)
- [src/Exceptions/DuplicateRouteIdException.php](#26)
- [src/Exceptions/PermissionDeniedException.php](#27)
- [src/Exceptions/PluginContextException.php](#28)
- [src/Lib/Obfuscator.php](#29)
- [src/Lib/Utils/ObfuscatorUtil.php](#30)
- [src/Models/AuditLog.php](#31)
- [src/Models/Author.php](#32)
- [src/Models/AuthorToken.php](#33)
- [src/Models/PermissionTag.php](#34)
- [src/Models/PermissionTagItem.php](#35)
- [src/Models/Plugin.php](#36)
- [src/Models/PluginAuditLog.php](#37)
- [src/Models/PluginIssue.php](#38)
- [src/Models/PluginIssueMessage.php](#39)
- [src/Models/PluginPermission.php](#40)
- [src/Models/PluginPermissionTag.php](#41)
- [src/Models/PluginPlaceholder.php](#42)
- [src/Models/PluginRoutePermission.php](#43)
- [src/Models/PluginSetting.php](#44)
- [src/Models/PluginSignature.php](#45)
- [src/Models/PluginToken.php](#46)
- [src/Models/PluginVersion.php](#47)
- [src/Models/PluginZip.php](#48)
- [src/Permissions/Evaluation/Dto/PermissionListResult.php](#49)
- [src/Permissions/Evaluation/Dto/PermissionListSummary.php](#50)
- [src/Permissions/Support/HostConfigNormalizer.php](#51)
- [src/Services/ErrorReaderService.php](#52)
- [src/Services/PolicyService.php](#53)
- [src/Services/ValidatorService.php](#54)
- [src/Support/CliSessionManager.php](#55)
- [src/Support/Encryption.php](#56)
- [src/Support/PluginContext.php](#57)
- [src/Traits/AuthenticateSession.php](#58)
- [src/Traits/ClientSession.php](#59)
...
<!-- PRODEx v1.4.7 | 2025-12-02T11:25:25.217Z -->