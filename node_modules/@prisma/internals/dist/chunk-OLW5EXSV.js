...
var chunk_OLW5EXSV_exports = {};
__export(chunk_OLW5EXSV_exports, {
...
module.exports = __toCommonJS(chunk_OLW5EXSV_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_EFZBTALL.addVersionDetailsToErrorMessage)(errorMessageWithContext));
    ...
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        if (process.env.FORCE_PANIC_QUERY_ENGINE_GET_CONFIG) {
          ...
          import_chunk_3TBTF5DA.prismaSchemaWasm.debug_panic();
        }
        ...
        const data = import_chunk_3TBTF5DA.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
